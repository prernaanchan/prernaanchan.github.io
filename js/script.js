...
// ---------- Demo ----------
//var CHART2_PARAMS = { labelWidth: 3, colors:['red', 'yellow', 'green', 'blue', 'orange'] };
//var CHART3_PARAMS = { initAnimation: false, max:5, rgbaFrom:[255, 0, 0, 1], rgbaTo:[255, 0, 0, .3] };
// sample data
var sample = [
  { id:1001, name: 'HTML5 & CSS3',       count: 9 },
  { id:1002, name: 'JavaScript & jQuery',       count: 8 },
  { id:1003, name: 'Angular.js',        count: 7 },
  { id:1004, name: 'Node.JS',          count: 7 },
  { id:1005, name: 'Python',            count: 5 },
  { id:1006, name: 'Bootstrap',         count: 7 },
  {id:1007, name: 'Java',         count: 6 },
  {id:1008, name: 'MongoDB',         count: 6 },
  {id:1009, name: 'AJAX',         count: 7 },
  {id:1009, name: 'JSON & XML',         count: 8 }
